...
class Sarafa_association extends Admin_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('Sarafa_association_model', 'model');
    }
    ...
    public function index()
    {
        ...
        $config['base_url'] = base_url() . 'sarafa_association/loadData/';
        ...
        $this->load_view('sarafa_association/view_sarafa', $data);
    }
    ...
    public function insert_record()
    {
        ...
        if ($customeremail == false) {
            ...
            redirect('admin/sarafa_association/add_sarafa');
        ...
        // } 
            ...
            redirect('admin/sarafa_association');
        }
    }

    /*------------------ edit view record ----------------------*/
    public function editSarafa($businessId)
    {
        ...
        //$data['mul_images'] = $this->model->getproductImages($businessId);
        // echo "<pre>";
        // print_r($data);
        // die;
        $this->load_view('sarafa_association/edit_sarafa', $data);
    }

    /*------------------ edit record in DB ----------------------*/
    public function update_sarafa($id)
    {
    ...
    public function createXLSVendors()
    {
        ...
        // exit();
        if (!is_dir('uploads/export_sarafa')) {
            mkdir('uploads/export_sarafa', 0777, TRUE);
        }
        // create file name
        $fileName = 'sarafa-' . time() . '.xlsx';
        $save_file = 'uploads/export_sarafa/' . $fileName;
        // load excel library
