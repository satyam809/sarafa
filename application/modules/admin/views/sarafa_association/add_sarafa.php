                    ...
                    <div class="d-flex align-items-center">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>admin/sarafa_association">View Sarafa Association</a></li>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-body">
                        ...
                        <form action="<?php echo base_url() ?>admin/sarafa_association/insert_record" method="POST" class="form-horizontal" enctype='multipart/form-data'>
                            <div class="card-body">
                                <div class="form-row">
                                    <div class="form-group col-lg-4">
                                        <label for="fname" class="text-right control-label col-form-label">Registration As<span class="mandatory">*</span></label>
                                        <input type="text" class="form-control" id="regAs" name="regAs" value="Sarafa Association" readonly>
                                    </div>
                                    <div class="form-group col-lg-4">
...
<script type="text/javascript">
    ...
    $(function() {
        $('button[name=cancel]').click(function() {
            window.location = site_path + 'admin/sarafa_association';
        });
    });
</script>
<script type="text/javascript">
