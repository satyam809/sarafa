<div id="main-wrapper">
    <div class="page-wrapper">
                    ...
                    <div class="d-flex align-items-center">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>admin/sarafa_association">View Business</a></li>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <form method="POST" action="<?php echo base_url() . 'admin/sarafa_association/update_sarafa/' . $data['int_glcode'];
...
<script type="text/javascript">
    ...
    $(document).on("click", "#btn_delete", function(e) {
        ...
        if (confirm("Do you really want to delete this")) {
            ...
            //alert(image);
            $.ajax({
                url: site_path + "admin/sarafa_association/deleteProductImges",
                type: "POST",
