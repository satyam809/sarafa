        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-5 align-self-center">
                    <h4 class="page-title">Sarafa Association</h4>
                    <div class="d-flex align-items-center">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>admin">Dashboard</a></li>
                                <li class="breadcrumb-item active" aria-current="page">All Sarafa Association</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                <div class="col-7 align-self-center">
                    <div class="d-flex no-block justify-content-end align-items-center">
                        <a id="add_cate" href="<?php echo base_url(); ?>admin/sarafa_association/add_sarafa" class="btn btn-info btn-rounded m-t-10 mb-2 float-right"><i class="mr-2 mdi mdi-plus"></i>Add New Sarafa Association</a>
                        <!-- <a id="add_cate" href="<?php //echo base_url(); 
                                                    ?>admin/sarafa_association/createXLSVendors" class="btn btn-primary btn-rounded m-t-10 mb-2 float-right"><i class="mr-2 mdi mdi-export"></i>Export Excel</a>
                        <a id="add_cate" href="<?php //echo base_url(); 
                                                ?>admin/sarafa_association/pdf_viewer" class="btn btn-primary btn-rounded m-t-10 mb-2 float-right"><i class="mr-2 mdi mdi-export"></i>Export PDF</a> -->
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <table id="user_list" class="table table-striped table-bordered" style="width:100%">
                                    <thead>
                                        ...
                                        <tr style="background-color: rgba(0,0,0,0.04)">
                                            ...
                                            <th><a href="javascript:void(0);" field="catAs" class="_sort">Category</a></th>
                                            <th>Publish</th>
                                        </tr>
                                    </thead>
                                        ...
                                        ?>
                                                <tr id="<?php echo $row["int_glcode"]; ?>">
                                                    ...
                                                    <!-- <td><?php //echo $row['int_glcode']; 
                                                                ?></td> -->
                                                    <td><a href="<?php echo base_url() . 'admin/sarafa_association/editSarafa/' . base64_encode($row['int_glcode']); ?>"><i class=" fas fa-pencil-alt"> </i> <?php echo $row['fname'] . ' ' . $row['lname']; ?></a>
                                                    </td>
        ...
        <script>
            ...
            $("#btn_search").click(function() {
                ...
                $.ajax({
                    ...
                    url: siteurl + 'admin/sarafa_association/loadData/' + pagenumber,
                    type: 'get',
                    data: {
                        append: append,
                        field: field,
            ...
            function loadPagination(pagno, field = 'int_glcode', sort = 'desc', entries = '10') {
                ...
                $.ajax({
                    ...
                    url: siteurl + 'admin/sarafa_association/loadData/' + pagno,
            ...
            function createTable(result, sno, total_rows, total_data) {
                ...
                for (index in result) {
                    ...
                    tr += "<td>" + id + "</td>";
                    tr += "<td><a href=" + siteurl + "admin/sarafa_association/editSarafa/" + window.btoa(id) + "><i class=' fas fa-pencil-alt'></i> " + fname + " " + lname + "</a></td>";
                    tr += "<td>" + var_email + "</td>";
                    tr += "<td>" + var_mobile + "</td>";
                    tr += "<td>" + var_city + "</td>";
                    tr += "<td>" + var_state + "</td>";
