            ...
            <div class="row">
                ...
                <div class="col-7 align-self-center">
                    <div class="d-flex no-block justify-content-end align-items-center">
                        <a id="add_cate" href="<?php echo base_url(); ?>admin/category/add_category" class="btn btn-info btn-rounded m-t-10 mb-2 float-right"><i class="mr-2 mdi mdi-plus"></i>Add New Category</a>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <table id="category_list" class="table table-striped table-bordered" style="width:100%">
                                    <thead>
                                        ...
                                        <tr style="background-color: rgba(0, 0, 3, 0.1);">
                                            ...
                                            <th><a href="javascript:void(0);" field="var_email" class="_sort">Category</a></th>
                                            <th>Icon</th>
                                            <th>Publish</th>
                                        </tr>
                                    </thead>
                                    ...
                                    <tbody>
                                        ...
                                        if (count($data) > 0) {
                                            foreach ($data as $row) {
                                                ...
                                                if ($row['var_icon'] != '') {
                                                    $Image = base_url() . 'uploads/category/' . $row['var_icon'];
                                                } else {
                                        ...
                                        ?>
                                                <tr id="<?php echo $row["int_glcode"]; ?>">
                                                    ...
                                                    <!-- <td><?php echo $row['int_glcode']; ?></td> -->
                                                    <td><a href="<?php echo base_url() . 'admin/category/editCategory/' . base64_encode($row['int_glcode']); ?>"><i class=" fas fa-pencil-alt"> </i> <?php echo $row['var_title']; ?></a>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td class="center">
                                                        <a href="javascript:void(0);">
                                                            <img id="tick-<?php echo $row['int_glcode']; ?>" height="16" width="16" alt="<?php echo $title; ?>" title="<?php echo $title; ?>" src="<?php echo base_url() . 'public/assets/images/site_imges/' . $tickimg; ?>" style="vertical-align:middle;cursor:pointer;" onclick="UpdatePublish('category', 'mst_category', 'chr_publish', '<?php echo $update_val; ?>', '<?php echo $row['int_glcode']; ?>');">
                                                        </a>
                                                    </td>
                                                </tr>
                                            <?php }
        ...
        <script>
            ...
            $("#btn_search").click(function() {
                ...
                $.ajax({
                    ...
                    url: siteurl + 'admin/category/loadData/' + pagenumber,
                    type: 'get',
                    data: {
                        append: append,
                        field: field,
            ...
            function loadPagination(pagno, field = 'int_glcode', sort = 'asc', entries = '10') {

                var append = $("#search").val();

                $.ajax({

                    url: siteurl + 'admin/category/loadData/' + pagno,
            ...
            function createTable(result, sno, total_rows, total_data) {
                ...
                if (result == null || result == '') {
                    ...
                    var tr = '<tr><td colspan="4">No results</td></tr>';
                ...
                for (index in result) {
                    ...
                    var parent_name = result[index].parent_name;
                    ...
                    var var_image = result[index].var_icon;
                    if (var_image != '') {
                        var image = siteurl + 'uploads/category/' + var_image;
                    } else {
                    ...
                    // tr += "<td>" + id + "</td>";
                    tr += "<td><a href=" + siteurl + "admin/category/editCategory/" + window.btoa(id) + ">" + var_title + "</a></td>";
                    // tr += "<td>"+ parent_name +"</td>";
                    ...
                    if (publish == 'Y') {
                        ...
                        var mst_module = "'mst_category'";
                        var chr_publish = "'chr_publish'";
                        var N = "'N'";

                        tr += '<td><a href="javascript:void(0);"><img id="tick-' + id +
                            '" height="16" width="16" alt="" title="" src="' + siteurl +
                            'public/assets/images/site_imges/tick.png" style="vertical-align:middle;cursor:pointer;" onclick="UpdatePublish(' + category + ',' + mst_module + ',' + chr_publish + ',' + N + ',' + id + ');"></a></td>';
                    } else {
                        ...
                        tr += '<td><a href="javascript:void(0);"><img id="tick-' + id +
                            '" height="16" width="16" alt="" title="" src="' + siteurl +
                            'public/assets/images/site_imges/tick_cross.png" style="vertical-align:middle;cursor:pointer;" onclick="UpdatePublish(' + category + ',' + mst_module + ',' + chr_publish + ',' + Y + ',' + id + ');"></a></td>';
                    }
