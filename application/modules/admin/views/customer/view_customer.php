            ...
            <div class="row">
                ...
                <div class="col-7 align-self-center">
                    <div class="d-flex no-block justify-content-end align-items-center">
                        <a id="add_cate" href="<?php echo base_url(); ?>admin/customer/add_customer" class="btn btn-info btn-rounded m-t-10 mb-2 float-right"><i class="mr-2 mdi mdi-plus"></i>Add New Customer</a>
                        <!-- <a id="add_cate" href="<?php //echo base_url(); 
                                                    ?>admin/customer/createXLSVendors" class="btn btn-primary btn-rounded m-t-10 mb-2 float-right"><i class="mr-2 mdi mdi-export"></i>Export Excel</a>
                        <a id="add_cate" href="<?php //echo base_url(); 
                                                ?>admin/customer/pdf_viewer" class="btn btn-primary btn-rounded m-t-10 mb-2 float-right"><i class="mr-2 mdi mdi-export"></i>Export PDF</a> -->
                    </div>
                </div>
            </div>
        </div>
                                        ...
                                        ?>
                                                <tr id="<?php echo $row["int_glcode"]; ?>">
                                                    ...
                                                    <!-- <td><?php //echo $row['int_glcode']; 
                                                                ?></td> -->
                                                    <td><a href="<?php echo base_url() . 'admin/customer/editCustomer/' . base64_encode($row['int_glcode']); ?>"><i class=" fas fa-pencil-alt"> </i> <?php echo $row['fname'] . ' ' . $row['lname']; ?></a>
                                                    </td>
        ...
        <script>
            ...
            $("#btn_search").click(function() {
                ...
                $.ajax({
                    ...
                    url: siteurl + 'admin/customer/loadData/' + pagenumber,
                    type: 'get',
                    data: {
                        append: append,
                        field: field,
            ...
            function loadPagination(pagno, field = 'int_glcode', sort = 'desc', entries = '10') {
                ...
                $.ajax({
                    ...
                    url: siteurl + 'admin/customer/loadData/' + pagno,
            ...
            function createTable(result, sno, total_rows, total_data) {
                ...
                for (index in result) {
                    ...
                    tr += "<td>" + id + "</td>";
                    tr += "<td><a href=" + siteurl + "admin/customer/editCustomer/" + window.btoa(id) + "><i class=' fas fa-pencil-alt'></i> " + fname + " " + lname + "</a></td>";
                    tr += "<td>" + var_email + "</td>";
                    tr += "<td>" + var_mobile + "</td>";
                    tr += "<td>" + var_city + "</td>";
                    tr += "<td>" + var_state + "</td>";
